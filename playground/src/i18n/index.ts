...
const messages = {
  'zh-CN': {
    ...
    langZh: '中文',
    langEn: 'English',
    homeKicker: 'OPEN SOURCE · VUE 3 · 90+ COMPONENTS',
    headline: '开源 Vue 3 组件库，主题、文档与预览一站齐全。',
    lead: '90+ 个组件共享同一套设计令牌与视觉语法。安装一个包，即可接入控件、亮暗主题与完整文档。',
    homeMetaComponents: '90+ 组件',
    start: '快速上手',
    browse: '浏览组件',
    viewGithub: 'GitHub',
    viewNpm: '在 npm 上查看',
    ...
    pillarCompleteBody: '90+ 个组件覆盖基础、表单、导航、数据展示与反馈，均支持 tree-shaking。',
  ...
  'en-US': {
    ...
    lead: '90+ components share one token-driven visual system. One package for UI primitives, light/dark themes, and full documentation.',
    homeMetaComponents: '90+ Components',
    start: 'Get started',
    ...
    pillarCompleteLabel: 'Complete',
    pillarCompleteTitle: '90+ components',
